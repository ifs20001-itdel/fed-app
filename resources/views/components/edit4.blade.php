...
<div class="shadow-lg hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full">
    <div class="container konten relative p-4 bg-whitety rounded-lg shadow sm:p-5">
        <div id="tambahData" data-modal-backdrop="static" tabindex="-1" aria-hidden="true" class="shadow-lg hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full">
            <div class="relative w-full max-w-2xl rounded-lg h-full md:h-auto bg-white">
                ...
                <div class="relative p-4 bg-whitety rounded-lg shadow sm:p-5">
                    ...
                    {{-- Modal Body --}}
                    <form action="/evaluasi-kerja/edit-data4" method="POST">
                        @csrf
                        <div>

                            @foreach ($datapenunjang as $dt)
                            ...
                            <div class="mb-2">
                                ...
                                <div class="input-group mb-3">
                                    <input type="file" value="{{$dt->bukti_penugasan}}" type="text" name="buktiPenugasan" id="tambahBukti" class="form-control">
